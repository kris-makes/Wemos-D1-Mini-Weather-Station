...
void draw_sensor() {
  ...
  do {
    ...
    u8g2.drawStr(5, 59, "Alt :       m");     //draw altitude
...
void scroll_sensor() {
  Temperature = (sensor_bmp.readTemperature() - 4.0);
  Pressure = (sensor_bmp.readPressure() / 100.0F  + 17);
  Altitude = (sensor_bmp.readAltitude(1010));
  timeClient.update();
  ...
  for (i = 0; i < 128; i = i + 4) {
    ...
    do {
      ...
      u8g2.print(Pressure, 1);
      u8g2.drawStr(5 - i, 59, "Alt :       m");     //draw altitude
...
void scroll_time() {
  ...
  for (i = 0; i < 128; i = i + 4) {
    ...
    do {
      ...
      u8g2.print(Pressure, 1);
      u8g2.drawStr(5 + 128 - i, 59, "Alt :       m");     //draw altitude
